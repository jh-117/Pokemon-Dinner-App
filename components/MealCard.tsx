...
const MealCard: React.FC<MealCardProps> = ({ meal, onReset, isImageLoading, isFavorite, onToggleFavorite }) => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto animate-in fade-in slide-in-from-bottom-8 duration-700 mb-12 relative flex flex-col">
      ...
      >
        <div className="w-10 h-10 rounded-full bg-white shadow-sm border border-gray-100 flex items-center justify-center group-hover:scale-110 group-hover:border-poke-dark transition-all">
            <ArrowLeft className="w-5 h-5 group-hover:text-poke-dark" />
        </div>
      ...
      <div className="flex flex-col md:flex-row gap-6 md:gap-12 items-start">
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-6">
            ...
            <div className="relative aspect-square w-full rounded-[2.5rem] bg-white shadow-poke border border-gray-100 p-8 flex items-center justify-center overflow-hidden group">
                ...
                <div className="flex flex-col items-center justify-center text-gray-300 z-10 w-full h-full">
                    {isImageLoading ? (
                        <div className="flex flex-col items-center gap-4 animate-pulse">
                            ...
                            <span className="text-xs font-bold text-gray-300 uppercase tracking-widest">Painting Dish...</span>
                        </div>
                    ) : (
